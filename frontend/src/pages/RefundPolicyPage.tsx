          ...
          <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Subscription Refund Policy</h2>
              </div>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">7-Day Money-Back Guarantee</h3>
                  <div className="bg-green-50 dark:bg-green-900/30 border-l-4 border-green-400 p-4 mb-4">
                    <div className="flex">
                      ...
                      <div>
                        <p className="text-green-800 font-semibold mb-2">New Subscribers Only</p>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">To qualify for the 7-day money-back guarantee, you must:</p>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Renewal Refunds</h3>
                  <div className="bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-400 p-4 mb-4">
                    <div className="flex">
                      ...
                      <div>
                        <p className="text-yellow-800 font-semibold mb-2">No Refunds for Renewals</p>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Partial Refunds</h3>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Cancellation Policy</h2>
              </div>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">How to Cancel</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-3">You can cancel your subscription at any time through:</p>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">What Happens After Cancellation</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Automatic Renewal</h3>
                  <p className="text-gray-600 dark:text-gray-300">
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">How to Request a Refund</h2>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6">
                  <ol className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Contact Support</h4>
                        <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Provide Information</h4>
                        <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Wait for Review</h4>
                        <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Receive Refund</h4>
                        <p className="text-gray-600 dark:text-gray-300">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Refund Exceptions</h2>
              </div>
              
              <p className="text-gray-600 dark:text-gray-300 mb-4">Refunds will NOT be issued in the following cases:</p>
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Billing Errors and Disputes</h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Unauthorized Charges</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Duplicate Charges</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Failed Cancellation</h3>
                  <p className="text-gray-600 dark:text-gray-300">
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Refund Payment Method</h2>
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Account Credits</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-8"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Need Help?</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
