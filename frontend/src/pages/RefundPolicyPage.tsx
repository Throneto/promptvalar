          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Subscription Refund Policy</h2>
              </div>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">7-Day Money-Back Guarantee</h3>
                  ...
                  <p className="text-gray-600">To qualify for the 7-day money-back guarantee, you must:</p>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Renewal Refunds</h3>
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4">
                    <div className="flex">
                      <XCircle className="w-6 h-6 text-yellow-600 mr-3 flex-shrink-0" />
                      <div>
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-3">You can cancel your subscription at any time through:</p>
                  <ol className="list-decimal list-inside text-gray-600 space-y-2 ml-4">
                    <li>Navigate to your <Link to="/dashboard/subscription" className="text-blue-600 hover:underline">Subscription Management</Link> page</li>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">What Happens After Cancellation</h3>
                  ...
                  <ol className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Email us at <a href="mailto:refunds@promptvalar.com" className="text-blue-600 hover:underline">refunds@promptvalar.com</a> with 
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Refund Exceptions</h2>
              </div>
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Billing Errors and Disputes</h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Unauthorized Charges</h3>
                  <p className="text-gray-600">
                    If you notice an unauthorized charge on your account, please contact us immediately at{' '}
                    <a href="mailto:billing@promptvalar.com" className="text-blue-600 hover:underline">billing@promptvalar.com</a>. 
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Failed Cancellation</h3>
                  <p className="text-gray-600">
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Refund Payment Method</h2>
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Account Credits</h2>
              <p className="text-gray-600 mb-4">
            ...
            >
              ...
              <ul className="text-gray-600 space-y-2">
                <li><strong>Refund Requests:</strong> <a href="mailto:refunds@promptvalar.com" className="text-blue-600 hover:underline">refunds@promptvalar.com</a></li>
                <li><strong>Billing Questions:</strong> <a href="mailto:billing@promptvalar.com" className="text-blue-600 hover:underline">billing@promptvalar.com</a></li>
                <li><strong>General Support:</strong> <a href="mailto:support@promptvalar.com" className="text-blue-600 hover:underline">support@promptvalar.com</a></li>
                <li><strong>Response Time:</strong> 24-48 hours (weekdays)</li>
              </ul>
              <div className="mt-6 pt-6 border-t border-gray-300">
                <p className="text-sm text-gray-500">
                  This Refund Policy is part of our <Link to="/terms" className="text-blue-600 hover:underline">Terms of Service</Link> and 
                  should be read in conjunction with our <Link to="/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>.
                </p>
              </div>
            </motion.div>
