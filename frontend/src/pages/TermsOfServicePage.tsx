        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-100 mb-4">To use our Services, you must:</p>
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">User Accounts</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Account Security</h3>
                  <p className="text-gray-600 dark:text-gray-100 mb-2">You are responsible for:</p>
                  <ul className="list-disc list-inside text-gray-600 dark:text-gray-100 space-y-2 ml-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Account Termination</h3>
                  <p className="text-gray-600 dark:text-gray-100">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Acceptable Use Policy</h2>
              </div>
              
              <p className="text-gray-600 dark:text-gray-100 mb-4">You agree not to use our Services to:</p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-100 space-y-2 ml-4">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Intellectual Property Rights</h2>
              </div>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Our Content</h3>
                  <p className="text-gray-600 dark:text-gray-100">
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Subscription and Payment Terms</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Price Changes</h3>
                  <p className="text-gray-600 dark:text-gray-100">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Cancellation</h3>
                  <p className="text-gray-600 dark:text-gray-100">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Prohibited Uses</h2>
              </div>
              
              <p className="text-gray-600 dark:text-gray-100 mb-4">In addition to the Acceptable Use Policy, you specifically agree not to:</p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-100 space-y-2 ml-4">
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">No Warranties</h3>
                  <p className="text-gray-600 dark:text-gray-100">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">AI-Generated Content Disclaimer</h3>
                  <p className="text-gray-600 dark:text-gray-100">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Limitation of Liability</h3>
                  <p className="text-gray-600 dark:text-gray-100 mb-2">
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Informal Resolution</h3>
                  <p className="text-gray-600 dark:text-gray-100">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Arbitration</h3>
                  <p className="text-gray-600 dark:text-gray-100">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Class Action Waiver</h3>
                  <p className="text-gray-600 dark:text-gray-100">
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Changes to Terms</h2>
            ...
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Severability and Waiver</h2>
              <p className="text-gray-600 dark:text-gray-100 mb-4">
