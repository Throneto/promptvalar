          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
                ...
                <Link to="/studio" className="text-purple-400 hover:text-purple-300 font-semibold">
                  Try Prompt Studio →
                </Link>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
                ...
                <Link to="/docs" className="text-purple-400 hover:text-purple-300 font-semibold">
                  Learn More →
                </Link>
              </div>
