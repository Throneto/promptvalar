      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <a href="#video-prompts" className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow cursor-pointer">
                <Video className="w-10 h-10 text-blue-600 mb-3" />
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Video Prompts</h3>
                <p className="text-sm text-gray-600">Sora & Veo guides</p>
              </a>
              
              <a href="#image-prompts" className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow cursor-pointer">
                <Image className="w-10 h-10 text-purple-600 mb-3" />
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Image Prompts</h3>
                <p className="text-sm text-gray-600">Midjourney & DALL-E</p>
              </a>
              
              <a href="#best-practices" className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow cursor-pointer">
                <Award className="w-10 h-10 text-green-600 mb-3" />
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Best Practices</h3>
                <p className="text-sm text-gray-600">Pro tips & tricks</p>
              </a>
              
              <a href="#examples" className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow cursor-pointer">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-4xl font-bold text-gray-900">Getting Started with Prompt Engineering</h2>
              </div>
              
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">What is Prompt Engineering?</h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">The Anatomy of a Great Prompt</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-6">
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">1. Subject</h4>
                      <p className="text-gray-600 mb-3">The main focus of your creation</p>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6">
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">2. Style & Aesthetics</h4>
                      <p className="text-gray-600 mb-3">The artistic direction and visual style</p>
                      <div className="bg-white rounded p-3 text-sm text-gray-700">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-lg p-6">
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">3. Details & Context</h4>
                      <p className="text-gray-600 mb-3">Specific attributes and environmental context</p>
                      <div className="bg-white rounded p-3 text-sm text-gray-700">
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-6">
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">4. Technical Parameters</h4>
                      <p className="text-gray-600 mb-3">Quality and format specifications</p>
                      <div className="bg-white rounded p-3 text-sm text-gray-700">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-4xl font-bold text-gray-900">Creating Video Prompts (Sora & Veo)</h2>
              </div>
              
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Video-Specific Considerations</h3>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <div>
                        <strong className="text-gray-900">Camera Movement:</strong>
                        <span className="text-gray-600"> Specify how the camera should move (pan, zoom, dolly, tracking shot)</span>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <span className="text-blue-600 font-bold mr-3">•</span>
                      <div>
                        <strong className="text-gray-900">Action & Motion:</strong>
                        <span className="text-gray-600"> Describe what's happening and how subjects move</span>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <span className="text-blue-600 font-bold mr-3">•</span>
                      <div>
                        <strong className="text-gray-900">Pacing:</strong>
                        <span className="text-gray-600"> Indicate the speed (slow motion, real-time, time-lapse)</span>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <span className="text-blue-600 font-bold mr-3">•</span>
                      <div>
                        ...
                        <span className="text-gray-600"> If applicable, describe scene transitions</span>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Example Video Prompts</h3>
                  
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6">
                      <div className="flex items-start justify-between mb-3">
                        <h4 className="text-lg font-semibold text-gray-900">Cinematic Drone Shot</h4>
                        <span className="px-3 py-1 bg-blue-600 text-white text-xs font-semibold rounded-full">Sora</span>
                      </div>
                      <div className="bg-white rounded-lg p-4 text-gray-700 font-mono text-sm mb-3">
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-6">
                      <div className="flex items-start justify-between mb-3">
                        <h4 className="text-lg font-semibold text-gray-900">Nature Scene</h4>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Pro Tips for Video Prompts</h3>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-4xl font-bold text-gray-900">Creating Image Prompts (Midjourney & DALL-E)</h2>
              </div>
              
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Image-Specific Techniques</h3>
                  <p className="text-gray-600 mb-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Example Image Prompts</h3>
                  
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
                      <div className="flex items-start justify-between mb-3">
                        <h4 className="text-lg font-semibold text-gray-900">Fantasy Character</h4>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6">
                      <div className="flex items-start justify-between mb-3">
                        <h4 className="text-lg font-semibold text-gray-900">Architectural Visualization</h4>
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6">
                      <div className="flex items-start justify-between mb-3">
                        <h4 className="text-lg font-semibold text-gray-900">Abstract Art</h4>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Style Modifiers & Keywords</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="border-2 border-purple-200 rounded-lg p-4">
                      <h5 className="font-semibold text-gray-900 mb-3">Artistic Styles</h5>
                    ...
                    <div className="border-2 border-blue-200 rounded-lg p-4">
                      <h5 className="font-semibold text-gray-900 mb-3">Quality Tags</h5>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="border-2 border-green-200 rounded-lg p-4">
                      <h5 className="font-semibold text-gray-900 mb-3">Lighting</h5>
                      <div className="flex flex-wrap gap-2">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-4xl font-bold text-gray-900">Best Practices & Pro Tips</h2>
              </div>
              
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Universal Prompt Principles</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-green-50 rounded-lg p-6">
                      <TrendingUp className="w-8 h-8 text-green-600 mb-3" />
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">Be Specific</h4>
                      <p className="text-gray-600 mb-3">
                        The more specific your description, the better the AI can understand your vision.
                      </p>
                      <div className="space-y-2 text-sm">
                        <div className="bg-white rounded p-3">
                          <p className="text-red-600 mb-1">❌ "A cat"</p>
                          <p className="text-green-600">✓ "A fluffy Persian cat with blue eyes sitting on a velvet cushion"</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-6">
                      ...
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">Use Descriptive Language</h4>
                      <p className="text-gray-600 mb-3">
                        Rich, vivid descriptions help AI models create more nuanced outputs.
                      </p>
                      <div className="space-y-2 text-sm">
                        <div className="bg-white rounded p-3">
                          <p className="text-red-600 mb-1">❌ "Nice lighting"</p>
                          <p className="text-green-600">✓ "Warm golden hour sunlight filtering through trees"</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-purple-50 rounded-lg p-6">
                      ...
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">Order Matters</h4>
                      <p className="text-gray-600 mb-3">
                        Place the most important elements at the beginning of your prompt.
                      </p>
                      <div className="space-y-2 text-sm">
                        <div className="bg-white rounded p-3">
                          <p className="text-green-600">✓ Start with the main subject, then add details</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-orange-50 rounded-lg p-6">
                      ...
                      <h4 className="text-lg font-semibold text-gray-900 mb-3">Iterate & Refine</h4>
                      <p className="text-gray-600 mb-3">
                        Don't expect perfection on the first try. Refine your prompts based on results.
                      </p>
                      <div className="space-y-2 text-sm">
                        <div className="bg-white rounded p-3">
                          <p className="text-gray-700">Test different variations and learn what works best</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start bg-red-50 rounded-lg p-4">
                      ...
                      <div>
                        <h5 className="font-semibold text-gray-900 mb-1">Being Too Vague</h5>
                    ...
                    <div className="flex items-start bg-red-50 rounded-lg p-4">
                      <span className="text-red-600 text-2xl mr-3">×</span>
                      <div>
                        <h5 className="font-semibold text-gray-900 mb-1">Overcomplicating</h5>
                        <p className="text-gray-600 text-sm">
                    ...
                    <div className="flex items-start bg-red-50 rounded-lg p-4">
                      <span className="text-red-600 text-2xl mr-3">×</span>
                      <div>
                        <h5 className="font-semibold text-gray-900 mb-1">Ignoring Model Strengths</h5>
                        <p className="text-gray-600 text-sm">
                    ...
                    <div className="flex items-start bg-red-50 rounded-lg p-4">
                      <span className="text-red-600 text-2xl mr-3">×</span>
                      <div>
                        <h5 className="font-semibold text-gray-900 mb-1">Forgetting Technical Parameters</h5>
                        <p className="text-gray-600 text-sm">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <Wand2 className="w-10 h-10 text-orange-600" />
                <h2 className="text-4xl font-bold text-gray-900">Real-World Use Cases</h2>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="border-2 border-gray-200 rounded-xl p-6 hover:border-blue-400 transition-colors">
                  <h4 className="text-xl font-semibold text-gray-900 mb-3">Marketing & Advertising</h4>
                  <p className="text-gray-600 mb-4">
                    Create stunning product visuals, social media content, and ad campaigns without expensive photoshoots.
                  </p>
                  <Link to="/library?category=marketing" className="text-blue-600 hover:underline text-sm font-semibold">
                    View Marketing Examples →
                  </Link>
                </div>

                <div className="border-2 border-gray-200 rounded-xl p-6 hover:border-purple-400 transition-colors">
                  <h4 className="text-xl font-semibold text-gray-900 mb-3">Content Creation</h4>
                  <p className="text-gray-600 mb-4">
                    Generate unique images and videos for blogs, YouTube thumbnails, and social media posts.
                  </p>
                  <Link to="/library?category=content" className="text-purple-600 hover:underline text-sm font-semibold">
                    View Content Examples →
                  </Link>
                </div>

                <div className="border-2 border-gray-200 rounded-xl p-6 hover:border-green-400 transition-colors">
                  <h4 className="text-xl font-semibold text-gray-900 mb-3">Game Development</h4>
                  <p className="text-gray-600 mb-4">
                    Create concept art, character designs, environment concepts, and promotional materials.
                  </p>
                  <Link to="/library?category=gaming" className="text-green-600 hover:underline text-sm font-semibold">
                ...
                <div className="border-2 border-gray-200 rounded-xl p-6 hover:border-orange-400 transition-colors">
                  ...
                  <Link to="/library?category=education" className="text-orange-600 hover:underline text-sm font-semibold">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  to="/studio" 
                  className="px-8 py-4 bg-white text-teal-600 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors"
                >
                  Try Prompt Studio
                </Link>
                <Link 
